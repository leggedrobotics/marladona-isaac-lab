...
class Agents(EnvCoreData):
    ...
    # kick_model_manager: KickModelManger = None
    # movement_model_manager: MovementModelManager = None
    ...
    def reset(self, env_ids):
        ...
        # active = self.env_data.act=ive[env_ids]
        # if len(active.nonzero(as_tuple=False)) > 0:
        #     pass
