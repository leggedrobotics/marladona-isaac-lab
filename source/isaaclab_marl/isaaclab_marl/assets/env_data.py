...
class SoccerGameCfg:
    ...
    num_agents_range = [2, num_agents_per_team]
...
class EnvData(EnvCoreData):
    ...
    def init_tensors(self):
        ...
        self.ball_inside_field = torch.zeros_like(self.is_training_env)
        self.ball_reset = torch.zeros_like(self.is_training_env)
