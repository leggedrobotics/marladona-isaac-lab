...
class MySceneCfg(InteractiveSceneCfg):
    ...
    def __post_init__(self):
        if self.terrain.terrain_generator.create_field_visuals:
            self.create_soccer_field_visual()
...
class SoccerMARLEnvPlayCfg(SoccerMARLEnvCfg):
    soccer_game = SoccerGameCfg(
        num_agents_per_team=5, num_agents_range=[5, 5], eval_env_ratio=0.0, level_settings=[[3, 3]]
    )
    ...
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator.create_field_visuals = True
